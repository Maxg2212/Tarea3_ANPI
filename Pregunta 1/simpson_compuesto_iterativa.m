% Funcion simpson_compuesto_iterativa(f, a, b, tol, iterMax)
...
function I = simpson_compuesto_iterativa(f, a, b, tol, iterMax)
    ...
    I_prev = simpson_compuesto(f, a, b, n);  % Primera aproximación
    iter = 1;
    ...
    while iter <= iterMax
        ...
        n = 2 * n;
        I = simpson_compuesto(f, a, b, n);  % Aproximación nueva
